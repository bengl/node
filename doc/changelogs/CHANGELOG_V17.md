...
* \[[`bdbe65571e`](https://github.com/nodejs/node/commit/bdbe65571e)] - **doc**: add marsonya to collaborators (Akhil Marsonya) [#41991](https://github.com/nodejs/node/pull/41991)
* \[[`8fe8dee684`](https://github.com/nodejs/node/commit/8fe8dee684)] - **doc**: deprecate notice for process methods (Yash Ladha) [#41587](https://github.com/nodejs/node/pull/41587)
...
* \[[`2f62a1c03e`](https://github.com/nodejs/node/commit/2f62a1c03e)] - **build**: cancel running CI jobs when a PR is updated (Michaël Zasso) [#42017](https://github.com/nodejs/node/pull/42017)
* \[[`f808b3f993`](https://github.com/nodejs/node/commit/f808b3f993)] - **build**: increase operations and test tag (Michael Dawson) [#42038](https://github.com/nodejs/node/pull/42038)
* \[[`5ce7acf454`](https://github.com/nodejs/node/commit/5ce7acf454)] - **build**: allow manual run of feature request action (Michael Dawson) [#42037](https://github.com/nodejs/node/pull/42037)
* \[[`428623eddf`](https://github.com/nodejs/node/commit/428623eddf)] - **build**: add action to close stale feature requests (Michael Dawson) [#41981](https://github.com/nodejs/node/pull/41981)
* \[[`3ffb2b243e`](https://github.com/nodejs/node/commit/3ffb2b243e)] - **build**: prevent concurrent CI and CQ workflow runs (Michaël Zasso) [#42016](https://github.com/nodejs/node/pull/42016)
* \[[`7a62554146`](https://github.com/nodejs/node/commit/7a62554146)] - **build**: use zoslib\_include\_dir provided by node-gyp (alexcfyung) [#41713](https://github.com/nodejs/node/pull/41713)
* \[[`959503714b`](https://github.com/nodejs/node/commit/959503714b)] - **build**: move tool updates workflow runtime a day later (Rich Trott) [#41982](https://github.com/nodejs/node/pull/41982)
* \[[`eb58753f9c`](https://github.com/nodejs/node/commit/eb58753f9c)] - **build**: extend yamllint configuration (Mestery) [#41756](https://github.com/nodejs/node/pull/41756)
* \[[`b968d89fc9`](https://github.com/nodejs/node/commit/b968d89fc9)] - **build**: remove broken x32 arch support (Ben Noordhuis) [#41905](https://github.com/nodejs/node/pull/41905)
...
* \[[`a1a91d9e90`](https://github.com/nodejs/node/commit/a1a91d9e90)] - **build,tools**: change the quotes in YAML (Mestery) [#41756](https://github.com/nodejs/node/pull/41756)
...
* \[[`6522c32cd9`](https://github.com/nodejs/node/commit/6522c32cd9)] - **crypto**: check result of BIO\_new in X509ToObject (Tobias Nießen) [#41979](https://github.com/nodejs/node/pull/41979)
* \[[`8c7f1df719`](https://github.com/nodejs/node/commit/8c7f1df719)] - **crypto**: rename X509\_NAME\_FLAGS (Tobias Nießen) [#42001](https://github.com/nodejs/node/pull/42001)
* \[[`add1660c48`](https://github.com/nodejs/node/commit/add1660c48)] - **(SEMVER-MINOR)** **crypto**: expose Web Crypto API on the global scope (Antoine du Hamel) [#41938](https://github.com/nodejs/node/pull/41938)
...
* \[[`d3eef0fd1a`](https://github.com/nodejs/node/commit/d3eef0fd1a)] - **debugger**: add debugger alias for exec(expr) (Xuguang Mei) [#41907](https://github.com/nodejs/node/pull/41907)
...
* \[[`dd66951245`](https://github.com/nodejs/node/commit/dd66951245)] - **deps**: upgrade npm to 8.5.1 (npm-robot) [#42039](https://github.com/nodejs/node/pull/42039)
* \[[`500bcb7b6b`](https://github.com/nodejs/node/commit/500bcb7b6b)] - **deps**: update undici to 3e267ece5f (Michaël Zasso) [#41955](https://github.com/nodejs/node/pull/41955)
...
* \[[`e03a25b9ea`](https://github.com/nodejs/node/commit/e03a25b9ea)] - **doc**: fix typo in http2 endAfterHeaders description (Alexandru Comanescu) [#42060](https://github.com/nodejs/node/pull/42060)
* \[[`c3fab79fad`](https://github.com/nodejs/node/commit/c3fab79fad)] - **doc**: make minor fixes to contributing guides (T-O-R-U-S) [#41966](https://github.com/nodejs/node/pull/41966)
* \[[`0301896e92`](https://github.com/nodejs/node/commit/0301896e92)] - **doc**: use openpgp.org for keyserver examples (Nick Schonning) [#39227](https://github.com/nodejs/node/pull/39227)
* \[[`0d7d6e7e98`](https://github.com/nodejs/node/commit/0d7d6e7e98)] - **doc**: adjust a/an word usage (Derek Wolpert) [#41915](https://github.com/nodejs/node/pull/41915)
* \[[`a6395bc314`](https://github.com/nodejs/node/commit/a6395bc314)] - **doc**: remove extra \<td> (Ray) [#42006](https://github.com/nodejs/node/pull/42006)
* \[[`e28d1972cb`](https://github.com/nodejs/node/commit/e28d1972cb)] - **doc**: capitalize valgrind (T•Ø•R•Ü•S) [#41986](https://github.com/nodejs/node/pull/41986)
* \[[`bdbe65571e`](https://github.com/nodejs/node/commit/bdbe65571e)] - **doc**: add marsonya to collaborators (Akhil Marsonya) [#41991](https://github.com/nodejs/node/pull/41991)
* \[[`8fe8dee684`](https://github.com/nodejs/node/commit/8fe8dee684)] - **doc**: deprecate notice for process methods (Yash Ladha) [#41587](https://github.com/nodejs/node/pull/41587)
* \[[`b85eb4561f`](https://github.com/nodejs/node/commit/b85eb4561f)] - **doc**: fix bug in `readable.unshift` code example (Xuguang Mei) [#41944](https://github.com/nodejs/node/pull/41944)
...
* \[[`23bb785ff7`](https://github.com/nodejs/node/commit/23bb785ff7)] - **esm**: improve `fetch_module` test coverage and remove hack (Antoine du Hamel) [#41947](https://github.com/nodejs/node/pull/41947)
* \[[`e1952813d3`](https://github.com/nodejs/node/commit/e1952813d3)] - **esm**: remove erroneous `context.parentURL` property passed to `load` hook (Jacob Smith) [#41975](https://github.com/nodejs/node/pull/41975)
...
* \[[`ba639d052b`](https://github.com/nodejs/node/commit/ba639d052b)] - **(SEMVER-MINOR)** **esm**: support https remotely and http locally under flag (Bradley Farias) [#36328](https://github.com/nodejs/node/pull/36328)
* \[[`6f5459d2e0`](https://github.com/nodejs/node/commit/6f5459d2e0)] - **events**: set default handler value (Benjamin Gruenbaum) [#41970](https://github.com/nodejs/node/pull/41970)
* \[[`0e44260bab`](https://github.com/nodejs/node/commit/0e44260bab)] - **fs**: fix default `length` parameter for `fs.read` (wbt) [#40349](https://github.com/nodejs/node/pull/40349)
* \[[`1f27974c29`](https://github.com/nodejs/node/commit/1f27974c29)] - **(SEMVER-MINOR)** **fs**: support copy of relative links with cp and cpSync (Marcos Bjoerkelund) [#41819](https://github.com/nodejs/node/pull/41819)
* \[[`672884eb5e`](https://github.com/nodejs/node/commit/672884eb5e)] - **fs**: fix cb/sync writev empty array behavior (Benjamin Gruenbaum) [#41932](https://github.com/nodejs/node/pull/41932)
...
* \[[`ff777f3fb3`](https://github.com/nodejs/node/commit/ff777f3fb3)] - **(SEMVER-MINOR)** **lib**: add FormData global when fetch is enabled (Michaël Zasso) [#41956](https://github.com/nodejs/node/pull/41956)
* \[[`2ab877f071`](https://github.com/nodejs/node/commit/2ab877f071)] - **lib**: stop installing webcrypto if `no_browser_globals` is `true` (Mestery) [#41971](https://github.com/nodejs/node/pull/41971)
* \[[`a522366769`](https://github.com/nodejs/node/commit/a522366769)] - **lib**: allow respondWithNewView on byob auto allocated streams (Sean Quinlan) [#41887](https://github.com/nodejs/node/pull/41887)
* \[[`bd4e550d97`](https://github.com/nodejs/node/commit/bd4e550d97)] - **lib**: stop installing fetch if no\_browser\_globals is true (Darshan Sen) [#41969](https://github.com/nodejs/node/pull/41969)
* \[[`ed74cc1b4c`](https://github.com/nodejs/node/commit/ed74cc1b4c)] - **lib**: restrict usage of fetch related globals in core internals (Antoine du Hamel) [#41957](https://github.com/nodejs/node/pull/41957)
...
* \[[`c6331041e8`](https://github.com/nodejs/node/commit/c6331041e8)] - **meta**: update AUTHORS (Node.js GitHub Bot) [#42058](https://github.com/nodejs/node/pull/42058)
* \[[`12269f7ca9`](https://github.com/nodejs/node/commit/12269f7ca9)] - **meta**: use plain emojis instead of escape sequences (Mestery) [#41989](https://github.com/nodejs/node/pull/41989)
* \[[`a8468ef534`](https://github.com/nodejs/node/commit/a8468ef534)] - **meta**: update AUTHORS and .mailmap (Rich Trott) [#41953](https://github.com/nodejs/node/pull/41953)
* \[[`777fb0003e`](https://github.com/nodejs/node/commit/777fb0003e)] - **perf\_hooks**: use arrays to store EntryBuffers (Xuguang Mei) [#42032](https://github.com/nodejs/node/pull/42032)
* \[[`5796c3a7ea`](https://github.com/nodejs/node/commit/5796c3a7ea)] - **process**: deprecate multipleResolves (Benjamin Gruenbaum) [#41872](https://github.com/nodejs/node/pull/41872)
...
* \[[`c76fd56f75`](https://github.com/nodejs/node/commit/c76fd56f75)] - **src,buffer**: evaluate THROW\_AND\_RETURN\_IF\_OOB() expression only once (Darshan Sen) [#41945](https://github.com/nodejs/node/pull/41945)
* \[[`79322f0d73`](https://github.com/nodejs/node/commit/79322f0d73)] - **stream**: add more forEach tests (Benjamin Gruenbaum) [#41937](https://github.com/nodejs/node/pull/41937)
* \[[`8949daa589`](https://github.com/nodejs/node/commit/8949daa589)] - **stream**: add more filter tests (Benjamin Gruenbaum) [#41936](https://github.com/nodejs/node/pull/41936)
* \[[`abd6967153`](https://github.com/nodejs/node/commit/abd6967153)] - **stream**: revert `map` spec compliance (Benjamin Gruenbaum) [#41931](https://github.com/nodejs/node/pull/41931)
...
* \[[`5c23e27b4f`](https://github.com/nodejs/node/commit/5c23e27b4f)] - **test**: remove test-stdout-close-catch flaky designation (Rich Trott) [#42045](https://github.com/nodejs/node/pull/42045)
* \[[`3051aeca26`](https://github.com/nodejs/node/commit/3051aeca26)] - **test**: check that fetch globals are disabled by default (Michaël Zasso) [#42015](https://github.com/nodejs/node/pull/42015)
* \[[`a4712be2a6`](https://github.com/nodejs/node/commit/a4712be2a6)] - **test**: improve vm test coverage (Yoshiki Kurihara) [#41847](https://github.com/nodejs/node/pull/41847)
* \[[`602acb217b`](https://github.com/nodejs/node/commit/602acb217b)] - **test**: run webmessaging/broadcastchannel WPT (Ben Noordhuis) [#41962](https://github.com/nodejs/node/pull/41962)
* \[[`603494473a`](https://github.com/nodejs/node/commit/603494473a)] - **test**: fix names of tests marked flaky on IBM i (Richard Lau) [#41984](https://github.com/nodejs/node/pull/41984)
* \[[`8f311a7b26`](https://github.com/nodejs/node/commit/8f311a7b26)] - **test**: fix typographical error (Rich Trott) [#41983](https://github.com/nodejs/node/pull/41983)
* \[[`f9eefc96ab`](https://github.com/nodejs/node/commit/f9eefc96ab)] - **test**: fix intl tests on small-icu builds (Antoine du Hamel) [#41939](https://github.com/nodejs/node/pull/41939)
...
* \[[`626577e460`](https://github.com/nodejs/node/commit/626577e460)] - **test**: improve `worker_threads ` coverage (Erick Wendel) [#41818](https://github.com/nodejs/node/pull/41818)
...
* \[[`3ae03ee8a8`](https://github.com/nodejs/node/commit/3ae03ee8a8)] - **tools**: update lint-md-dependencies to rollup\@2.67.3 (Node.js GitHub Bot) [#42057](https://github.com/nodejs/node/pull/42057)
* \[[`33aad74a5a`](https://github.com/nodejs/node/commit/33aad74a5a)] - **tools**: enable es2022 env in ESLint config (Michaël Zasso) [#42043](https://github.com/nodejs/node/pull/42043)
* \[[`4787d927d2`](https://github.com/nodejs/node/commit/4787d927d2)] - **tools**: add `console` to the list of restricted globals (Antoine du Hamel) [#42012](https://github.com/nodejs/node/pull/42012)
* \[[`cb470d5333`](https://github.com/nodejs/node/commit/cb470d5333)] - **tools**: lint deprecation codes (Antoine du Hamel) [#41992](https://github.com/nodejs/node/pull/41992)
* \[[`2c807443cd`](https://github.com/nodejs/node/commit/2c807443cd)] - **tools**: fix bugs in prefer-primordials linter rule (Antoine du Hamel) [#42010](https://github.com/nodejs/node/pull/42010)
* \[[`14e63e1820`](https://github.com/nodejs/node/commit/14e63e1820)] - **tools**: add timers functions to the list of restricted globals (Antoine du Hamel) [#42013](https://github.com/nodejs/node/pull/42013)
* \[[`4d3a7013fb`](https://github.com/nodejs/node/commit/4d3a7013fb)] - **tools**: reduce list of globals in ESLint config (Rich Trott) [#41996](https://github.com/nodejs/node/pull/41996)
* \[[`c354f002f3`](https://github.com/nodejs/node/commit/c354f002f3)] - **tools**: update remark-preset-lint-node to 3.3.1 (Rich Trott) [#41999](https://github.com/nodejs/node/pull/41999)
* \[[`b1b81f5638`](https://github.com/nodejs/node/commit/b1b81f5638)] - **tools**: update ESLint to 8.9.0 (Luigi Pinca) [#41973](https://github.com/nodejs/node/pull/41973)
* \[[`dccdb03de7`](https://github.com/nodejs/node/commit/dccdb03de7)] - **tools**: update lint-md-dependencies to rollup\@2.67.2 (Node.js GitHub Bot) [#41941](https://github.com/nodejs/node/pull/41941)
...
* \[[`53bbbc8932`](https://github.com/nodejs/node/commit/53bbbc8932)] - **tools,lib**: remove `global` and `Intl` from the list of globals (Antoine du Hamel) [#42014](https://github.com/nodejs/node/pull/42014)
* \[[`2d2afd49d9`](https://github.com/nodejs/node/commit/2d2afd49d9)] - **worker**: fix typo in debug statement (Antoine du Hamel) [#42011](https://github.com/nodejs/node/pull/42011)
