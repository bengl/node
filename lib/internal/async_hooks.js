...
const promiseInitHook = (promise, parent) => fastPromiseHook(kInit, promise, parent)
const promiseBeforeHook = (promise, parent) => fastPromiseHook(kBefore, promise, parent)
const promiseAfterHook = (promise, parent) => fastPromiseHook(kAfter, promise, parent)
const promiseResolveHook = (promise, parent) => fastPromiseHook(kPromiseResolve, promise, parent)
...
function updatePromiseHookMode() {
  ...
  if (destroyHooksExist()) {
    ...
    setPromiseHooks(promiseInitHook, promiseBeforeHook, promiseAfterHook, promiseResolveHook);
  }
}
